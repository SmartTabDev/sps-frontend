...
export const allegroFiltersInitialState: AllegroFilters = {
  searchFilter: '',
  selectedBrands: [],
  priceRange: null,
  badges: {
...
type Props = {
  filterDispatch: FilterDispatch<AllegroFilters>;
  filterState: AllegroFilters;
  handleClear: () => void;
  handleApply: () => void;
  refreshKey: string;
        ...
        <FieldWrapper $marginTopSize="small">
          <>
            <Badges
              ...
              isSponsored={badges.isSponsored}
