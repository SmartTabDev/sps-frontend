...
export type MarketRadarFilters = {
  selectedRetailers: { name: string; id: number }[];
  selectedCategories: { name: string; id: number }[];
  timeDimension: TimeDimension;
};

export const marketRadarFiltersInitialState: MarketRadarFilters = {
  selectedRetailers: [],
  selectedCategories: [],
  timeDimension: {
    name: 'Last week',
...
type Props = {
  filterDispatch: FilterDispatch<MarketRadarFilters>;
  filterState: MarketRadarFilters;
  handleClear: () => void;
  handleApply: () => void;
  refreshKey: string;
