...
type Props = {
  filterDispatch: FilterDispatch<RSPIndexFilters>;
  filterState: RSPIndexFilters;
  handleClear: () => void;
  handleApply: () => void;
  refreshKey: string;
